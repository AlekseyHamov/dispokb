...
public class HierarchicalDataSet : IHierarchicalDataSource
{
    ...
    public HierarchicalDataSet(string TableName, string idColumnName, string parentIdColumnName)
    {
        ...
        string sqlCmd = "SELECT [" + idColumnName + "], [" + parentIdColumnName +"], [Text]"+
                        " FROM " + TableName;
        ...
        if (ds.Tables[0].Columns[idColumnName].DataType != ds.Tables[0].Columns[parentIdColumnName].DataType)
            throw new Exception("The two column names passed should be of the same type");

        columnIsString = ds.Tables[0].Columns[idColumnName].DataType == typeof(string);
        System.Diagnostics.Debug.Assert(
            ds.Tables[0].Columns[idColumnName].DataType ==
            ds.Tables[0].Columns[parentIdColumnName].DataType,
            "The Column of the ID and the Column of the ParentID should be of the same type");
    }
    public HierarchicalDataSet(string TableName, string idColumnName, string parentIdColumnName, string ColumnValue)
    {
        if (ConfigurationManager.ConnectionStrings["ApplicationServices"] == null ||
            ConfigurationManager.ConnectionStrings["ApplicationServices"].ConnectionString.Trim() == "")
        {
        ...
        string sqlCmd = "SELECT [" + idColumnName + "], [" + parentIdColumnName + "], [" + ColumnValue + "]" +
                        " FROM " + TableName;
        ...
        this.idColumnName = idColumnName;
        this.parentIdColumnName = parentIdColumnName;
        this.rootParentColumnValue = null;
